...
parser.add_argument('--optimizer', default='adam3', type=str)
...
parser.add_argument('--lr_decay', choices=['step', 'cosine'], required=True, help='Decay rate of learning rate')
parser.add_argument('--last_lr', type=float, default=0.0001, help='last learning rate for consine lr scheduler')
...
def main_worker(gpu, ngpus_per_node, args):
    filename = './train_log_no_reproduce/seed-{}-lrannealing-{}-model-{}-optimizer-{}-lr-{}-epochs-{}-decay-epoch-{}-eps{}-beta1{}-beta2{}-l2-decay{}-warmup-{}-fixed-decay-{}-lastlr-{}-batchsize-{}'.format(args.seed, args.lr_decay, args.arch, args.optimizer, args.lr, args.epochs, args.when, args.eps, args.beta1, args.beta2, args.weight_decay, args.warmup, args.fixed_decay, args.last_lr, args.batch_size)
    ...
    if args.optimizer == 'sgd' and (not args.centralize):
        ...
        optimizer = AdaM3(model.parameters(), args.lr, eps=args.eps, betas=(args.beta1, args.beta2), weight_decay=args.weight_decay, fixed_decay=args.fixed_decay)
    else:
    ...
    if args.lr_decay=='cosine':
        scheduler = CosineAnnealingLR(optimizer, T_max=args.epochs, eta_min=args.last_lr)
