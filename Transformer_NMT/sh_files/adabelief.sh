...
export CUDA_VISIBLE_DEVICES=0; python main.py ${DATA_PATH} \
                            ...
                            --optimizer adabeliefv2 --adam-betas '(0.9, 0.999)' --clip-norm 0.0 \
