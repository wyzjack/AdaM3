...
# seed 0
OUTPUT_PATH=log_0.999_5e-4/adam3_0
mkdir -p $OUTPUT_PATH
export CUDA_VISIBLE_DEVICES=0; python main.py ${DATA_PATH} \
                            --seed 0 \
                            --adam-eps 1e-16 \
                            --rectify True --weight-decouple True \
                            --arch ${ARCH} --share-all-embeddings \
                            --optimizer adam3 --adam-betas '(0.9, 0.999)' --clip-norm 0.0 \
...
OUTPUT_PATH=log_0.999_5e-4/adam3_1
mkdir -p $OUTPUT_PATH
export CUDA_VISIBLE_DEVICES=0; python main.py ${DATA_PATH} \
                            --seed 1 \
                            --adam-eps 1e-16 \
...
OUTPUT_PATH=log_0.999_5e-4/adam3_2
mkdir -p $OUTPUT_PATH
export CUDA_VISIBLE_DEVICES=0; python main.py ${DATA_PATH} \
                            --seed 2 \
                            --adam-eps 1e-16 \
...
OUTPUT_PATH=log_0.999_5e-4/adam3_3
mkdir -p $OUTPUT_PATH
export CUDA_VISIBLE_DEVICES=0; python main.py ${DATA_PATH} \
                            --seed 3 \
                            --adam-eps 1e-16 \
...
OUTPUT_PATH=log_0.999_5e-4/adam3_4
mkdir -p $OUTPUT_PATH
export CUDA_VISIBLE_DEVICES=0; python main.py ${DATA_PATH} \
                            --seed 4 \
                            --adam-eps 1e-16 \
